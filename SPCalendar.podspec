...
Pod::Spec.new do |s|
  s.name             = 'SPCalendar'
  s.version          = '0.1.0'
  s.summary          = 'A short description of SPCalendar.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/SPCalendar'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'SPCalendar' => 'sarfraz.akhtar4@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/SPCalendar.git', :tag => s.version.to_s }
